      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <button
              onClick={() => setOpen(false)}
              className="absolute top-5 right-5 md:top-8 md:right-8 text-cream text-sm tracking-wide border border-cream/40 px-3 py-1.5 rounded-md hover:bg-cream hover:text-charcoal transition-colors"
              aria-label="Cerrar"
            >
              Cerrar ✕
            </button>
