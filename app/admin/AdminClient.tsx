  ...
  return (
    <main className="bg-cream min-h-screen px-6 md:px-12 py-10 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-10">
        <h1 className="font-display text-charcoal text-3xl tracking-logo">
          gozart admin
        </h1>
        <button
          onClick={logout}
      ...
      >
        <h2 className="col-span-full font-sans text-sm text-graphite uppercase tracking-wide">
      ...
      {/* Listado */}
      <h2 className="font-sans text-sm text-graphite uppercase tracking-wide mb-4">
